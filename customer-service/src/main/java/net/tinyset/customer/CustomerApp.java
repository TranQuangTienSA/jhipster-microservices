package net.tinyset.customer;

import net.tinyset.customer.client.OAuth2InterceptedFeignConfiguration;
import net.tinyset.customer.config.ApplicationProperties;
import net.tinyset.customer.config.DefaultProfileUtil;
