...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("customer");
        ...
        config.setInstanceName("customer");
        ...
        config.getMapConfigs().put("net.tinyset.customer.domain.*", initializeDomainMapConfig(jHipsterProperties));
