package net.tinyset.customer.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import net.tinyset.customer.domain.AbstractAuditingEntity;
import net.tinyset.customer.domain.EntityAuditEvent;
import net.tinyset.customer.repository.EntityAuditEventRepository;
