...
import net.tinyset.customer.config.SecurityBeanOverrideConfiguration;
...
import net.tinyset.customer.web.rest.errors.ExceptionTranslator;
...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_PHONE = "14574680722573373";
    private static final String UPDATED_PHONE = "75129359";
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getOwnerLogin()).isEqualTo(DEFAULT_OWNER_LOGIN);
    }
    ...
    @Test
    @Transactional
    public void checkOwnerLoginIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setOwnerLogin(null);
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.getOwnerLogin()).isEqualTo(UPDATED_OWNER_LOGIN);
    }
