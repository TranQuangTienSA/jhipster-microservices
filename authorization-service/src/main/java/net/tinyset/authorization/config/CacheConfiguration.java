...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("authorization");
        ...
        config.setInstanceName("authorization");
        ...
        config.getMapConfigs().put("net.tinyset.authorization.domain.*", initializeDomainMapConfig(jHipsterProperties));
