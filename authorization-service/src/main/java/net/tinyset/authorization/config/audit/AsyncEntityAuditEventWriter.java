package net.tinyset.authorization.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import net.tinyset.authorization.domain.AbstractAuditingEntity;
import net.tinyset.authorization.domain.EntityAuditEvent;
import net.tinyset.authorization.repository.EntityAuditEventRepository;
